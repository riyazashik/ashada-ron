...
$products_data = array();
						...
						$objPHPExcel->getActiveSheet()->setCellValue('C12', "Previous\n month ($)")->getStyle('C12')->applyFromArray($style_center)->getFont()->setBold( true );
						$objPHPExcel->getActiveSheet()->getStyle('C12')->getAlignment()->setWrapText(true);
						$objPHPExcel->getActiveSheet()->setCellValue('D12', "This\n month ($)")->getStyle('D12')->applyFromArray($style_center)->getFont()->setBold( true );
						...
						$objPHPExcel->getActiveSheet()->setCellValue('G12', "Previous\n month ($)")->getStyle('G12')->applyFromArray($style_center)->getFont()->setBold( true );
						$objPHPExcel->getActiveSheet()->getStyle('G12')->getAlignment()->setWrapText(true);
						$objPHPExcel->getActiveSheet()->setCellValue('H12', "This\n month ($)")->getStyle('H12')->applyFromArray($style_center)->getFont()->setBold( true );
						...
						$objPHPExcel->getActiveSheet()->setCellValue('K12', "Previous\n month ($)")->getStyle('K12')->applyFromArray($style_center)->getFont()->setBold( true );
						$objPHPExcel->getActiveSheet()->getStyle('H12')->getAlignment()->setWrapText(true);
						$objPHPExcel->getActiveSheet()->setCellValue('L12', "This\n month ($)")->getStyle('L12')->applyFromArray($style_center)->getFont()->setBold( true );
